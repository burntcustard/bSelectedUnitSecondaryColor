...
void main() 
{
    ...
    else
    {
        ...
        vec3 color = v_SelectedState > 0.0 ? (texel.r * mix(mixColor, v_ColorSecondary.rgb, pow(texel.g, 1.0 / 2.2) / (texel.a + 0.00001))) : (texel.r * mix(mixColor, v_ColorPrimary.rgb, pow(texel.g, 1.0 / 2.2) / (texel.a + 0.00001)));
